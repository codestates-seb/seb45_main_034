  ...
  return (
    <aside className="sidebar">
      ...
      <div className={`side-list ${showCategories ? "show" : ""}`}>
        <button onClick={() => handleGenreClick("슈퍼히어로")}>슈퍼히어로</button>
        <button onClick={() => handleGenreClick("로맨틱 코미디")}>로맨틱 코미디</button>
        <button onClick={() => handleGenreClick("느와르")}>느와르</button>
        ...
        <button onClick={() => handleGenreClick("어드벤쳐")}>어드벤쳐</button>
      </div>
